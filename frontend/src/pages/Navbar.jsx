...
const Navbar = () => {
    ...
    return (
        <nav className="navbar">
            <a href="/home" id='home'><h3 className="logo">Library</h3></a>
            <ul className={isMobile ? "nav-links-mobile" : "nav-links"} onClick={() => setIsMobile(false)}>
                <li className='nav'><a href="/home">Home</a></li>
                <li className='nav'><a href="/sea">Search</a></li>
                <li className='nav'><a href="/fav">Favaroite</a></li>
                {/* <li className='nav'><a href="/info">User info</a></li> */}
